...
function Banner({ netflixOriginals }: Props) {
  ...
  return (
    <div className="flex flex-col space-y-2 py-16 lg:h-[65vh] lg:justify-end lg:pb-12 space-x-0 lg:space-x-4 md:space-x-4">
      ...
      <div className="flex space-x-3">
        <button className="bannerButton  text-black">
